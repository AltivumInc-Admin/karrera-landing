    ...
    return (
      <div>
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-6 text-center">
          <p className="text-yellow-700 font-medium mb-2">Resume data unavailable</p>
          <p className="text-yellow-600 text-sm mb-4">Your resume was parsed but the data could not be loaded. Try uploading again.</p>
          <ResumeUpload />
        </div>
      </div>
    );
